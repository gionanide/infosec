#!usr/bin/python
def changeFormat():
	with open('/home/manos/number.txt','r') as inputFile:
		with open ('/home/manos/readyText.txt','w') as outputFile:
			text = []
...
def ex3():
    flag=1
    with open('/home/manos/readyText.txt','r') as textFile:
...
def countLettersFrequency(list):
    ...
    frequencyArray=['e','t','a','o','i','n','s','h','r','d','l','c','u','m','n','f','g','y','p','b','v','k','j','x','q','z']
